...
export const copy = {
  ...
  settings: {
    ...
    toastCopySuccessTitle: "Identifier copied",
    toastCopySuccessMsg: "Settings identifier copied to clipboard.",
    toastCopyErrorTitle: "Copy failed",
    toastCopyErrorMsg: "Could not copy identifier to clipboard.",
  },
};
