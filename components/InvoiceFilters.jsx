...
function DirectionToggle({ column, filters, onFilterChange }) {
  ...
  return (
    <button
      ...
      className={`rounded px-2 py-1 text-xs font-mono transition-colors select-none focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:ring-offset-1 focus-visible:ring-offset-slate-950 ${
        isActive
  ...
  return (
    <div className="flex flex-wrap gap-4 items-center">
      ...
      <button
        ...
        disabled={!active}
        className={`ml-auto rounded-lg border px-4 py-2 text-sm transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 ${
          active
