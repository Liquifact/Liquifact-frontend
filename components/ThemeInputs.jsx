...
export default function ThemeInputs({
  ...
  const errors = useMemo(
    () => validateThemeInputs(theme, accentColour),
    [theme, accentColour]
  );
  ...
  const isSubmitDisabled = disabled || submitting || errors.theme !== null || errors.accentColour !== null;
  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        ...
        {visibleThemeError && (
          <p id={themeErrorId} role="alert" aria-live="polite" className="mt-1 text-xs text-red-400">
            {visibleThemeError}
          </p>
        )}
      </div>
      ...
      <div className="mb-6">
        ...
        <select
          ...
          disabled={disabled || submitting}
          aria-describedby={visibleAccentError ? `${accentHelperId} ${accentErrorId}` : accentHelperId}
        ...
        {visibleAccentError && (
          <p id={accentErrorId} role="alert" aria-live="polite" className="mt-1 text-xs text-red-400">
            {visibleAccentError}
          </p>
        )}
      </div>
