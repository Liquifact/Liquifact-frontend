...
export function formatCurrency(
  ...
  const formatterOptions = compact
    ? { ...standardOptions, notation: 'compact', compactDisplay: 'short' }
    : standardOptions;
  ...
  try {
    ...
    try {
      return createFormatter(locale, standardOptions).format(numericValue);
    } catch {
      return createFormatter(locale, defaultCurrencyOptions).format(numericValue);
    }
  }
}
