...
describe('useWalletUrlState', () => {
  ...
  it('should update search term and debounce URL update', () => {
    ...
    expect(mockRouter.replace).toHaveBeenCalledWith('/wallet?q=new-search&sort=date&direction=desc', { scroll: false });
  });
  ...
  it('should update sort state and debounce URL update', () => {
    ...
    expect(mockRouter.replace).toHaveBeenCalledWith('/wallet?sort=status&direction=asc', { scroll: false });
  });
  ...
  it('should remove empty search term from URL', () => {
    ...
    expect(mockRouter.replace).toHaveBeenCalledWith('/wallet?sort=date&direction=desc', { scroll: false });
  });
});