...
export const DASHBOARD_INVOICE_SHORTCUT_KEY = "b";
export const DASHBOARD_INVEST_SHORTCUT_KEY = "v";
export const DASHBOARD_HEALTH_SHORTCUT_KEY = "h";
...
export const KEYBOARD_SHORTCUTS = [
  ...
  {
    id: "dashboard-invoice-navigate",
    key: DASHBOARD_INVOICE_SHORTCUT_KEY,
    description: "Go to the Invoices page",
    scope: "page:dashboard",
  },
  {
    id: "dashboard-invest-navigate",
    key: DASHBOARD_INVEST_SHORTCUT_KEY,
    description: "Go to the Invest page",
    scope: "page:dashboard",
  },
  {
    id: "dashboard-health-check",
    key: DASHBOARD_HEALTH_SHORTCUT_KEY,
    description: "Run a health check on the backend API",
    scope: "page:dashboard",
  },
  {
    id: "shortcut-help",
