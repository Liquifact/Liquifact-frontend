...
export const INVOICE_DETAIL_SHORTCUT_KEY = "i";
export const INVOICE_DETAIL_EXPORT_SHORTCUT_KEY = "e";
export const INVOICE_DETAIL_FUND_SHORTCUT_KEY = "f";
export const INVOICE_DETAIL_COPY_SHORTCUT_KEY = "c";
export const UPLOAD_BROWSE_SHORTCUT_KEY = "u";
export const UPLOAD_SUBMIT_SHORTCUT_KEY = "s";
...
export const KEYBOARD_SHORTCUTS = [
  ...
  {
    id: "invoice-detail-navigate",
    key: INVOICE_DETAIL_SHORTCUT_KEY,
    description: "Go to Invoice Detail (opens the most-recent invoice)",
    scope: "global",
  },
  {
    id: "invoice-detail-export",
    key: INVOICE_DETAIL_EXPORT_SHORTCUT_KEY,
    description: "Focus the export (CSV / JSON) buttons on the invoice detail page",
    scope: "page:invoice-detail",
  },
  {
    id: "invoice-detail-fund",
    key: INVOICE_DETAIL_FUND_SHORTCUT_KEY,
    description: "Focus the fund invoice action on the invoice detail page",
    scope: "page:invoice-detail",
  },
  {
    id: "invoice-detail-copy",
    key: INVOICE_DETAIL_COPY_SHORTCUT_KEY,
    description: "Copy the invoice share link on the invoice detail page",
    scope: "page:invoice-detail",
  },
  {
    id: "upload-browse",
    key: UPLOAD_BROWSE_SHORTCUT_KEY,
    description: "Focus the upload dropzone to select a PDF invoice file",
    scope: "page:upload",
  },
  {
    id: "upload-submit",
    key: UPLOAD_SUBMIT_SHORTCUT_KEY,
    description: "Submit the selected invoice for upload and tokenization",
    scope: "page:upload",
  },
  {
    id: "shortcut-help",
