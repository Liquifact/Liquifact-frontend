...
/**
 * Settings page shortcuts (scope: "page:settings").
 * These are wired in app/settings/page.js and only active while the
 * settings page is mounted.
 */
export const SETTINGS_SEARCH_SHORTCUT_KEY = "s";
export const SETTINGS_FILTER_SHORTCUT_KEY = "f";
export const SETTINGS_RESET_SHORTCUT_KEY = "r";
export const SETTINGS_LOAD_MORE_SHORTCUT_KEY = "l";
export const SETTINGS_EXPORT_SHORTCUT_KEY = "e";
...
export const KEYBOARD_SHORTCUTS = [
  ...
  },
  {
    ...
    key: SETTINGS_SEARCH_SHORTCUT_KEY,
    description: "Focus the settings search input",
    scope: "page:settings",
  },
  {
    id: "settings-filter-focus",
    key: SETTINGS_FILTER_SHORTCUT_KEY,
    description: "Focus the settings category filter",
    scope: "page:settings",
  },
  {
    id: "settings-reset-filters",
    key: SETTINGS_RESET_SHORTCUT_KEY,
    description: "Reset active settings filters",
    scope: "page:settings",
  },
  {
    id: "settings-load-more",
    key: SETTINGS_LOAD_MORE_SHORTCUT_KEY,
    description: "Load more settings preferences",
    scope: "page:settings",
  },
  {
    id: "settings-export",
    key: SETTINGS_EXPORT_SHORTCUT_KEY,
    description: "Focus the settings export buttons",
    scope: "page:settings",
  },
  {
    id: "shortcut-help",
